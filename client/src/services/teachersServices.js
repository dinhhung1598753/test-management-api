...
export const getAllTeachersService = async (params, successCallback, errorCallback) => {
  await getRequest(`${apiPath.allTeachers}`, params, successCallback, errorCallback, 10000);
};
...
export const addTeachersService = async (params, successCallback, errorCallback) => {
  await postRequest(`${apiPath.addTeacher}`, params, successCallback, errorCallback, 10000);
};
